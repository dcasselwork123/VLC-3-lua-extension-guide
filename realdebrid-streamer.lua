...
function create_main_dialog()
    ...
    dlg:add_button("⚙️ Settings", function() show_settings_view() end, 4, 2, 1, 1)
...
function show_home_view()
    ...
    dlg:add_button("▶️ Stream", function()
    ...
    dlg:add_button("⚙️ Settings", function() show_settings_view() end, 3, 10, 1, 1)
...
function show_movies_view()
    ...
    -- Pagination
    dlg:add_button("◀️ Previous", function() prev_page() end, 1, 10, 1, 1)
...
function show_settings_view()
    ...
    dlg:add_label("<h2>⚙️ Settings</h2>", 1, 1, 4, 1)
